    ...
    return Scaffold(
      body: SafeArea(
        child: ListView(
          children: [
            SizedBox(height: 40,),
            Center(child: Text("Share Preffrence",style: TextStyle(color: Colors.black,fontSize: 30,fontWeight: FontWeight.bold),)),
            SizedBox(height: 20,),
            Center(
              child: TextField(
         ...
         SizedBox(height: 20,),
           ...
           Center(
            ...
            Center(
              child: ElevatedButton(onPressed: () {
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) =>  HomeSharePrefAdd(),));
              }, child: Text("Add")),
            ),
            SizedBox(height: 20,),
